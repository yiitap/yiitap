...
<h2>Diagrams</h2><h3>Flow</h3><pre><code class="language-mermaid">sequenceDiagram
    participant Alice
    participant Bob
    ...
    Bob--&gt;John: Jolly good!</code></pre><h2>Table</h2><p></p>
`
...
&lt;/html&gt;</code></pre><h2>Diagrams</h2><h3>Flowchart</h3><pre><code class="language-mermaid">graph TD
    ...
    John--&gt;Alice: Great!
    John-&gt;Bob: How about you?
    Bob--&gt;John: Jolly good!</code></pre><h3>Pie Chat</h3><pre><code class="language-mermaid">%%{init: { "theme": "forest" }}%%
